...
This program uses A* `algorithm` to find an optimal path to get from point A to point B. Here, I used `data structure` (list, set, and dictionary) to provide the best performance.
